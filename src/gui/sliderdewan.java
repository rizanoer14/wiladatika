...
public class sliderdewan extends javax.swing.JFrame {
...
public void show(int index)
{
    ...
    private void nextMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_nextMousePressed
      new Thread();
        try {
            ...
            Logger.getLogger(sliderdewan.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sliderdewan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new sliderdewan().setVisible(true);
            }
        });
    }
