...
public class detail_sudirman extends javax.swing.JFrame {
 private Connection conn = new konek().connect();
  ...
  protected void tampil(){
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        slidersudirman n = new slidersudirman();
        n.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(detail_sudirman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new detail_sudirman().setVisible(true);
            }
        });
    }
